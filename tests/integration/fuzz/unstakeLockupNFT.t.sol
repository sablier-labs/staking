...
contract UnstakeLockupNFT_Integration_Fuzz_Test is Shared_Integration_Fuzz_Test {
    ...
    function _test_UnstakeLockupNFT(uint40 timestamp, uint128 amountUnstaked) private {
        ...
        vars.expectedTotalAmountStaked = sablierStaking.totalAmountStaked(poolIds.defaultPool) - amountUnstaked;
        ...
        assertEq(vars.actualLastUpdateTime, timestamp, "actualLastUpdateTime");
        assertEq(
