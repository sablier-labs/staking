...
abstract contract Constants {
    ...
    uint8 internal constant STREAMS_STAKED_BY_RECIPIENT_PRE_START = 0;
    uint128 internal constant TOTAL_AMOUNT_STAKED_PRE_START =
    ...
    uint8 internal constant STREAMS_STAKED_BY_RECIPIENT_START_TIME = 1;
    uint128 internal constant TOTAL_AMOUNT_STAKED_START_TIME =
    ...
    uint8 internal constant STREAMS_STAKED_BY_RECIPIENT_20_PERCENT = 2;
    uint128 internal constant TOTAL_AMOUNT_STAKED_20_PERCENT =
    ...
    uint8 internal constant STREAMS_STAKED_BY_RECIPIENT = 2;
    uint128 internal constant TOTAL_AMOUNT_STAKED = TOTAL_DIRECT_AMOUNT_STAKED + TOTAL_STREAM_AMOUNT_STAKED;
    ...
    uint8 internal constant STREAMS_STAKED_BY_RECIPIENT_END_TIME = 2;
    uint128 internal constant TOTAL_AMOUNT_STAKED_END_TIME = TOTAL_AMOUNT_STAKED;
